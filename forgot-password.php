...
if($query -> rowCount() > 0)
{
$con="update nguoidung set matkhau=:newpassword where id_email=:email and sdt_nd=:mobile";
...
<div class="banner-1 ">
	<div class="container">
		<h1 class="wow zoomIn animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: zoomIn;">Website đặt tour du lịch</h1>
	</div>
</div>
...
<div class="privacy">
	...
	<p style="width: 350px;">
			...
			<b>Email</b>  <input type="email" name="email" class="form-control" id="email" placeholder="Nhập email" required="">
	</p> 

	<p style="width: 350px;">
		
			<b>Điện thoại</b>  <input type="text" name="mobile" class="form-control" id="mobile" placeholder="Nhập số điện thoại" required="">
	</p> 
