...
<body>
	<div class="page-container">
		<div class="left-content">
			...
			<ol class="breadcrumb">
				<li class="breadcrumb-item"><a href="index.php">Home</a><i class="fa fa-angle-right"></i>Cập nhật dữ liệu trang </li>
			</ol>
			<div class="grid-form">
					...
					<div class="tab-content">
						<div class="tab-pane active" id="horizontal-form">
							<form class="form-horizontal" name="package" method="post" enctype="multipart/form-data">
								<div class="form-group">
									...
									<div class="col-sm-8">
										<select name="menu1" onChange="MM_jumpMenu('parent',this,0)">
											...
											<option value="manage-pages.php?type=Điều khoản">Điều kiện và điều khoản</option>
											<option value="manage-pages.php?type=Chính sách và bảo mật">Bảo mật và chính sách</option>
								...
								<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Lựa chọn trang</label>
									<div class="col-sm-8">
										<?php
								...
								<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Nội dung trang</label>
									<div class="col-sm-8">
