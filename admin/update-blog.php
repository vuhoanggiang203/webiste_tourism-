										...
										{	?>
											...
											<form class="form-horizontal" name="package" method="post" enctype="multipart/form-data">
												...
												<div class="form-group">
													...
													<div class="col-sm-8">
														<input type="text" class="form-control1" name="nguoiviet" id="packageprice" placeholder=" Ngày đi" value="<?php echo htmlentities($result->nguoiviet);?>" required>
													</div>
												</div>
												...
												<div class="form-group">
													...
													<div class="col-sm-8">
														<img src="pacakgeimages/<?php echo htmlentities($result->hinhanh);?>" width="200">&nbsp;&nbsp;&nbsp;<a href="image-blog.php?imgid=<?php echo htmlentities($result->id_blog);?>">Thay đổi ảnh</a>
													</div>
												</div>
