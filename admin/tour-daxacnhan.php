					...
					<div class="w3l-table-info">
						...
						<div class="col-xs-12 col-sm-2 col-md-2 dashboard-nav">
							<ul style="width: 500px;margin-top: 30px; list-style: none;">
								<li style="margin-top: -19px;" class="active"><a href="manage-bookings.php"><span><i class="fas fa-motorcycle"></i></span> Tour</a></li>
						...
						<table id="table">
							...
							<tbody>
								<?php $sql = "SELECT hoadon.id_hoadon as bookid,nguoidung.hoten as fname,nguoidung.sdt_nd as mnumber,nguoidung.id_email as email,goidulich.tengoi as pckname,goidulich.giagoi as giagoi,goidulich.songay as sngay,goidulich.ngayxuatphat as xphat,hoadon.id_goi as pid,hoadon.nguoilon as nguoilon,hoadon.treem as treem,hoadon.trenho as trenho,hoadon.embe as embe,hoadon.phongdon as phongdon,hoadon.ngaydat as ndat,hoadon.trangthai as status,hoadon.huy as cancelby,hoadon.huy as upddate from nguoidung join  hoadon on  hoadon.email_nguoidung=nguoidung.id_email join goidulich on goidulich.id_goi=hoadon.id_goi";
								$query = $dbh -> prepare($sql);
								$query->execute();
									...
									foreach($results as $result)
										{				?>		
											<tr>
												...
												<td><a href="update-package.php?pid=<?php echo htmlentities($result->pid);?>"><?php echo htmlentities($result->giagoi);?></a></td>

												<td style="width: 100px;"><?php echo htmlentities($result->sngay);?> ngày,</br> Xuất phát từ: </br><?php echo date("d-m-Y", strtotime($result->xphat)); ?></td>
												...
												<td><?php echo htmlentities($result->phongdon) + 1;?></td>
