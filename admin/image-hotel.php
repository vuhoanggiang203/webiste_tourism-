...
{	
	...
	if(isset($_POST['submit']))
	{
		...
		$sql="update khachsan set hinhanh=:pimage where id_ks=:imgid";
	...
	<html>
	<head>
		<title>Ảnh khách sạn</title>		<link rel="icon" href="images/favicon.ico" type="image/x-icon">
						...
						<div class="tab-content">
							<div class="tab-pane active" id="horizontal-form">
								<form class="form-horizontal" name="package" method="post" enctype="multipart/form-data">
									<?php 
									$imgid=intval($_GET['imgid']);
									$sql = "SELECT hinhanh from khachsan where id_ks=:imgid";
									$query = $dbh -> prepare($sql);
									$query -> bindParam(':imgid', $imgid, PDO::PARAM_STR);
									$query->execute();
										...
										foreach($results as $result)
											{	?>	
												<div class="form-group">
													<label for="focusedinput" class="col-sm-2 control-label"> Ảnh khách sạn </label>
													<div class="col-sm-8">
