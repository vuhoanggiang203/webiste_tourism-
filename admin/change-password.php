...
<body>
    <div class="page-container">
        <div class="left-content">
            ...
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="manage-bookings.php">Trang chủ</a><i
                        class="fa fa-angle-right"></i>Thông tin <i class="fa fa-angle-right"></i> Thay đổi mật khẩu</li>
            </ol>
            <div class="grid-form">

                <div class="grid-form1">

                    <?php if($error){?><div class="errorWrap"><strong>Xảy ra
                            lỗi</strong>:<?php echo htmlentities($error); ?> </div><?php } 
						else if($msg){?><div class="succWrap"><strong>Hoàn thành</strong>:<?php echo htmlentities($msg); ?> </div>
                    <?php }?>
